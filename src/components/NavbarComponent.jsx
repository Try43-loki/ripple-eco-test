                    ...
                    <NavigationMenuList>
                        ...
                        <NavigationMenuContent>
                            <div className="w-[160px] px-2 py-2 space-y-2 text-[#697D74]">
                                <NavigationMenuLink href='' className="w-full flex flex-row items-center gap-x-2"><ClipboardList />Take Action</NavigationMenuLink>
                                <NavigationMenuLink href='' className="w-full flex flex-row items-center gap-x-2"><MessageCircleQuestion />Discussion</NavigationMenuLink>
                            </div>
                        </NavigationMenuContent>
                        </NavigationMenuItem>
                    </NavigationMenuList>
                    ...
                    <NavigationMenuList>
                        ...
                        <NavigationMenuContent>
                            <div className="w-[180px] px-2 py-2 space-y-2 text-[#697D74]">
                                <NavigationMenuLink href='' className="w-full flex flex-row items-center gap-x-2"><SunDim />Air Quality</NavigationMenuLink>
                                <NavigationMenuLink href='' className="w-full flex flex-row items-center gap-x-2"><Wind />Natural Disastor</NavigationMenuLink>
                            </div>
                        </NavigationMenuContent>
                        </NavigationMenuItem>
                    </NavigationMenuList>
            ...
            <div className='flex gap-x-[10px] items-center w-[100px] justify-end'>
                ...
                <div className='flex items-center'>
                    <Popover>
                        <PopoverTrigger>
                            <div >
                                <img src='https://i.pinimg.com/736x/24/21/99/2421998d6c1e6bdc695a4243ba70f0ab.jpg' alt='avatar' className='w-[30px] h-[30px] rounded-full'/>
