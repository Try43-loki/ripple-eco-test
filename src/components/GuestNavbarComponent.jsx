...
const GuestNavbarComponent = () => {
  return (
    <>
      <nav className='flex flex-row items-center justify-between px-[35px] py-[25px] w-full bg-[#E3DFDF1A] rounded-[30px] border-1 border-solid border-[#FFFFFF] text-white text-[18px] '>
        <div>
            <Link href=''>
