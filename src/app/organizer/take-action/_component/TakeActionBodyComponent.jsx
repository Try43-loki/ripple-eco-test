...
const TakeActionBodyComponent = () => {
  return (
    <>
      ...
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="flex flex-row gap-x-2 bg-white h-auto rounded-[14px] p-1.5 border-1 border-border">
            <TabsTrigger
              value="all"
              className={cn(
  ...
  "data-[state=active]:bg-meduim-green data-[state=active]:text-white"
          ...
          <hr className='mt-5 text-strong-gray '/>
          <TabsContent value="own-post" className="w-full mt-5 mb-10 flex flex-row items-center justify-between">
          ...
          <TabsContent value="all" className="w-full mt-5 mb-10 flex flex-row items-center justify-between">
          <Link href={{
    ...
    query: { type: 'view' },
            ...
            <Link href={{
    pathname: '/organizer/take-action/2',
    query: { type: 'view' },
  }} className='w-65'>
                <TakeActionCard
                image={"/sub-banner.jpg"}
            ...
            <Link href={{
    pathname: '/organizer/take-action/3',
    query: { type: 'view' },
  }} className='w-65'>
                <TakeActionCard
                image={"/sub-banner.jpg"}
            ...
            <Link href={{
    pathname: '/organizer/take-action/4',
    query: { type: 'view' },
  }} className='w-65'>
                <TakeActionCard
                image={"/sub-banner.jpg"}
